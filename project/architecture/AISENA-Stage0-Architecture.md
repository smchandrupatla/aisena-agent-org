# AISENA Stage 0 Architecture

## Purpose
Define the minimal architecture for the AISENA Stage 0 proof-of-concept and establish component responsibilities for a runnable toy screening flow.
...
- `Kafka Cluster`
  ...
  - Contains one topic: `aisena-stage0-events`.

- `OpenSearch`
  - Stores screening result documents in an index: `aisena-stage0-screening-results`.
...
2. The event is published to `aisena-stage0-events`.
...
## Interface Contracts
- `aisena-stage0-events` Kafka topic message:
