# Agent 20 — Search & OpenSearch SME

Role: Search & OpenSearch SME
...
- `/agents/20-search-opensearch-sme`
...
Handoff format:
- Use `/project/handoffs/<task-id>-20-search-opensearch-sme-to-product-owner.md` or equivalent.
...
- `scripts/agents/run-agent.sh 20-search-opensearch-sme`
...
Last-Updated: 2026-08-11T06:39:56.192939Z
