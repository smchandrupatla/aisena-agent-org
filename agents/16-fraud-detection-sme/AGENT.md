# Agent 16 — Fraud Detection SME

Role: Fraud Detection SME
...
Handoff format:
- Use `/project/handoffs/<task-id>-16-fraud-detection-sme-to-product-owner.md` or equivalent.
...
- `scripts/agents/run-agent.sh 16-fraud-detection-sme`
...
Last-Updated: 2026-08-11T06:47:56.117003Z
