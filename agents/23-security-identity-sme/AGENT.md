# Agent 23 — Security & Identity SME

Role: Security & Identity SME
...
- `/agents/23-security-identity-sme`
...
Handoff format:
- Use `/project/handoffs/<task-id>-23-security-identity-sme-to-product-owner.md` or equivalent.
...
- `scripts/agents/run-agent.sh 23-security-identity-sme`
...
Last-Updated: 2026-08-11T06:14:21.092653Z
