...
- [ ] Ensure the story is feasible for a toy proof and does not require full production rules.
- [ ] Confirm the handoff files and requirements are stored under `/project`.
