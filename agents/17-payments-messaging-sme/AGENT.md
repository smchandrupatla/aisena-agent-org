# Agent 17 — Payments & Messaging SME (ISO 20022)

Role: Payments & Messaging SME (ISO 20022)
...
- `/agents/17-payments-messaging-sme`
...
Handoff format:
- Use `/project/handoffs/<task-id>-17-payments-messaging-sme-to-product-owner.md` or equivalent.
...
- `scripts/agents/run-agent.sh 17-payments-messaging-sme`
...
Last-Updated: 2026-08-18T12:55:17.550378Z
