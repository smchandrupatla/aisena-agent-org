# Agent 21 — Streaming & Messaging Infra SME (Kafka/Flink)

Role: Streaming & Messaging Infra SME (Kafka/Flink)
...
- `/agents/21-streaming-messaging-infra-sme`
...
Handoff format:
- Use `/project/handoffs/<task-id>-21-streaming-messaging-infra-sme-to-product-owner.md` or equivalent.
...
- `scripts/agents/run-agent.sh 21-streaming-messaging-infra-sme`
...
Last-Updated: 2026-08-11T06:43:26.549678Z
