# Agent 24 — Case Management & UX SME

Role: Case Management & UX SME
...
- `/agents/24-case-management-ux-sme`
...
Handoff format:
- Use `/project/handoffs/<task-id>-24-case-management-ux-sme-to-product-owner.md` or equivalent.
...
- `scripts/agents/run-agent.sh 24-case-management-ux-sme`
...
Last-Updated: 2026-08-18T13:04:43.322432Z
