...
Handoff format:
- Use `/project/handoffs/<task-id>-22-cloud-aws-sme-to-product-owner.md` or equivalent.
...
- `scripts/agents/run-agent.sh 22-cloud-aws-sme`
...
Last-Updated: 2026-08-18T12:33:03.036662Z
